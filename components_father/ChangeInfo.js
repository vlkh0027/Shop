            ...
            <View style={wrapper}>
                <View style={header}>
                    <TouchableOpacity onPress={()=>{this.goBackToMain()}}>
                        <Image source={require('./../image/back.png')} style={backIconStyle} />
                    </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    header: { flex: 1, backgroundColor: '#24ffff', alignItems: 'center', justifyContent: 'space-between', flexDirection: 'row', paddingHorizontal: 10 },// eslint-disable-line
